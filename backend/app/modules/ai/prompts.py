IMPROVE_SYSTEM_PROMPT = (
    ...
    "conciseness, and engagement. Preserve all technical accuracy. Return only the improved text."
)
...
SEO_TITLE_SYSTEM_PROMPT = (
    ...
    'for the following article. Return JSON only: {"seo_title": "...", "seo_description": "..."}'
)
